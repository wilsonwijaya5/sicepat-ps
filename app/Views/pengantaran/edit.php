...
<?= $this->section('content') ?>
    ...
    <?php
    // Debugging
    var_dump($pengantaran);
    var_dump($detailPengantaran);
        ...
        function geocodePosition(pos, index) {
            ...
            geocoder.geocode({
                ...
                if (status == google.maps.GeocoderStatus.OK) {
                    ...
                    document.getElementById('alamat_penerima' + index).value = 'Geocoder failed due to: ' + status;
                }
            });
        }

        function geocodeAddress(geocoder, map, marker, index) {
